...
const ContactUs = () => {
  return (
    <>
      <Helmet>
        <title>Contact Us - AI WebX | Reach Out for Technology Solutions</title>
        <meta
          name="description"
          content="Get in touch with AI WebX for customized AI, Machine Learning, and Blockchain solutions. We're here to help you with all your technology needs."
        />
        <meta
          name="keywords"
          content="Contact AI WebX, AI solutions, Machine Learning, Blockchain, Technology Consulting"
        />
        <link rel="canonical" href="https://www.aiwebx.com/contact-us" />

        {/* Open Graph Tags */}
        <meta
          property="og:title"
          content="Contact Us - AI WebX | Reach Out for Technology Solutions"
        />
        <meta
          property="og:description"
          content="Contact AI WebX today to discuss how our AI, Machine Learning, and Blockchain solutions can elevate your business."
        />
        <meta property="og:image" content={companyDetails.logo} />
        <meta property="og:url" content="https://www.aiwebx.in/contact-us" />
        ...
        <meta
          ...
          content="Connect with AI WebX for cutting-edge AI, Machine Learning, and Blockchain solutions. We're here to help your business succeed."
        />
