  ...
  return (
    <div className="bg-[#fafafa]">
      ...
      <section className="wrapper py-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-7 lg:gap-5">
          <div className="sm:col-span-2 md:col-span-3 lg:col-span-1 flex flex-col gap-3">
            ...
            <h2 data-aos="fade-up" className="heading-2 capitalize">We are ready for your help</h2>
          ...
          <div data-aos="fade-up" className="rounded-md relative bg-primary/5 group hover:bg-primary p-7 border-t-2 border-secondary bg-black/5 flex flex-col">
      ...
      <section className="wrapper mt-10">
        <div data-aos="fade-up" className="max-w-5xl mx-auto -mb-[8rem] bg-white p-8 shadow-large shadow-black/10 rounded-lg relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-7 lg:gap-5">
          <div className="flex flex-col gap-3">
            ...
            <p data-aos="fade-up" className="max-w-[35rem] lg:max-w-max">
              At AI WebX, we’re dedicated to providing technology solutions that
          ...
          <form data-aos="fade-up" className="flex flex-col gap-5">
            ...
            <button type="button" className="px-4 py-3 text-white bg-secondary rounded-sm w-full max-w-[50%]">
              Send Message
            </button>
          </form>
        </div>
