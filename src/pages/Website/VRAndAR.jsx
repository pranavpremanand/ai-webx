    ...
    <div className="flex flex-col gap-10">
      ...
      <div className="flex flex-col gap-4">
        ...
        <p data-aos="fade-up" className="description">
          ...
          with digital content and the world around us. At AI WebX, we are
        ...
        <p data-aos="fade-up" className="description">
          ...
          WebX, we understand that each industry has unique requirements and
      ...
      <p>
        At AI WebX, we prioritize user experience in all our VR and AR
