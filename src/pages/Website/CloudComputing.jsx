...
loading="lazy"        data-aos="fade-up"
      ...
      <div className="flex flex-col gap-4">
        ...
        <p data-aos="fade-up" className="description">
          ...
          scalability, and efficiency. At AI WebX, we offer comprehensive cloud
        ...
        <p data-aos="fade-up" className="description">
          ...
          <br />
          <br />
          At AI WebX, we offer a range of cloud services, including
...
loading="lazy"            
      ...
      <p>
        As technology continues to evolve, AI WebX remains committed to
