...
import { companyDetails, localBusinessSchema } from "../../data/constant";
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          property="og:title"
          content="About Us - AI WebX | Leading AI & Technology Solutions Provider"
        />
        <meta
          property="og:description"
          content="Discover more about AI WebX and how our cutting-edge AI, Machine Learning, and Blockchain solutions can help you grow."
        />
        <meta property="og:image" content={companyDetails.logo} />
        <meta property="og:url" content="https://www.aiwebx.in/about-us" />
        ...
        <meta
          ...
          content="Learn more about AI WebX and how our innovative technology solutions can benefit your business."
        />
      ...
      <div className="landing-bg">
        ...
        <section className="wrapper text-center">
          ...
          <p>
            ...
            specializes in providing cutting-edge AI, blockchain, and ML
            services across a wide range of sectors including energy,
            healthcare, e-commerce, real estate, and more. Our solutions are
            tailored to the unique needs of each client, ensuring the perfect
            blend of innovation and practicality.
            <br />
            <br />
            With a strong focus on empowering businesses, we offer a
            comprehensive suite of services that includes cloud computing, data
            analytics, cybersecurity, and advanced software development. We
            pride ourselves on delivering intelligent, scalable, and secure
            solutions that help our clients unlock new opportunities and achieve
            sustainable growth.
          </p>
        </section>
        <SolveITNeeds />
