...
const UnlockPossibilities = () => {
  return (
    <div className="bg-gradient-to-r from-[#062533] via-[#024464] to-[#012130] py-[5rem] z-10">
     ...
     <div data-aos="fade-right" className="flex flex-col items-center md:items-start h-full justify-between gap-5">
      ...
      <img data-aos="fade-left" src={keyImg} alt="" className="w-full sm:w-4/6 aspect-video object-contain" />
     </div>
    </div>
  );
};
